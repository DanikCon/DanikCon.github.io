...
(async () => {
  ...
  function buildApp() {
    ...
    style.textContent = `
      ...
      .menu-grid .social-menu-btn{display:inline-flex;justify-content:center;align-items:center;gap:8px;text-align:center;padding-left:12px;padding-right:12px}.menu-grid .social-menu-btn .button-icon{position:static;transform:none;flex:0 0 auto;margin:0;width:1.08em;height:1.08em}.menu-grid .social-menu-btn .button-icon + span{display:inline-block;width:11.5em;max-width:calc(100% - 24px);min-width:0;text-align:center;line-height:1.12;white-space:normal}
