...
// Версия: GamePush v1.46 — правки модерации VK/OK: 3 подсказки на новую игру и мгновенное применение покупок OK.
(async () => {
  "use strict";
  ...
  const CONFIG = {
    ...
    products: {
      ...
      frostDeck: "deck_frost",
      amberDeck: "deck_amber"
    },
    ...
    async purchase(productTag) {
      try {
        ...
        if (this.kind === "gamepush" && this.gp?.payments?.purchase) {
          ...
          // Some OK adapters resolve purchase() without a useful receipt. Force-refresh the GamePush
          // product/player-purchase catalogue and retry for a few seconds before leaving it pending.
          ...
          // will continue checking this exact tag and apply it as soon as OK reports ownership.
