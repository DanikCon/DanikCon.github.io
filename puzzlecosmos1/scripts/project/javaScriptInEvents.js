...
const scriptsInEvents = {
	...
	async Gameplay_Event78_Act1(runtime, localVars)
	{
...
window.addEventListener('resize', window.c3FxResizeHandler);
	...
	async Gameplay_Event79_Act2(runtime, localVars)
	{
...
window.mySyncTimer = setInterval(() => {
	...
	async Gameplay_Event79_Act3(runtime, localVars)
	{
	...
	async Gameplay_Event79_Act4(runtime, localVars)
	{
