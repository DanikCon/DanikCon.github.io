    ...
    showModal(t("brand"), `
      ...
      <div class="menu-actions">
        ...
        <div class="modal-grid menu-grid">
          ...
          ${platform.canInviteFriend() ? `<button class="modal-btn secondary" data-action="invite-friend">${uiIcon("invite", "button-icon")}<span>${t("inviteFriend")}</span></button>` : ""}
          ${communityUrl ? `<a class="modal-btn secondary social-link" href="${escapeHtml(communityUrl)}" target="_blank" rel="noopener noreferrer">${uiIcon("community", "button-icon")}<span>${t("joinGroup")}</span></a>` : ""}
