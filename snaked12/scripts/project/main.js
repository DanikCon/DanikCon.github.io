...
class SlitherArena {
  ...
  fitOverlayPanel(renderPreviews = false) {
    ...
    // Allow a stronger zoom-out on very short landscape webviews. The final CSS
    // keeps text and controls compact, so this normally remains above 0.65.
    const minimumScale = isMenu ? .34 : .45;
