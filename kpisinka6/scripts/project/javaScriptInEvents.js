...
// Версия: GamePush v1.45.11 — соцкнопки используют ту же раскладку и стили, что остальные кнопки меню.
(async () => {
  "use strict";
