...
const I18N = Object.freeze({
  ...
  en: {
    ...
    home: { brand: "Neon Arena", title: "Snake: Neon Rush", subtitle: "Collect energy, grow, and survive in the cyber arena.", daily: "Daily goal • +{reward} ★", complete: "complete", missions: "Daily tasks • {done}/{total}", missionsHint: "Finish all — streak and +{stars} ★", dayStreak: "day streak", record: "Record", skins: "Skins", league: "League", play: "Play", tasks: "Tasks", wardrobe: "Wardrobe", rating: "Leaderboard", controls: "Controls: {mode}", touch: "Touch", joystick: "Joystick", invite: "Invite a friend", joinVk: "Follow VK", joinOk: "Follow OK" },
...
class SlitherArena {
  ...
  createDom() {
    ...
    this.root.innerHTML = `
      <style>
        #slither-arena-root { position:fixed; inset:0; z-index:2147482000; overflow:hidden; touch-action:none; overscroll-behavior:none; user-select:none; -webkit-user-select:none; -webkit-touch-callout:none; -webkit-user-drag:none; font-family:Manrope,Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif; color:#fdf8ff; }
        ...
        .sa-shell { position:absolute; inset:0; overflow:hidden; background:radial-gradient(circle at 15% 15%, rgba(255,78,205,.10), transparent 30%), radial-gradient(circle at 82% 18%, rgba(0,245,212,.10), transparent 28%), linear-gradient(180deg,#150a24 0%,#0d1029 52%,#060913 100%); }
        ...
        .sa-hud-card { min-width:174px; padding:11px 14px; border:1px solid rgba(255,255,255,.12); border-radius:20px; background:linear-gradient(135deg,rgba(42,18,67,.84),rgba(8,13,35,.74)); box-shadow:0 16px 42px rgba(0,0,0,.34),0 0 0 1px rgba(255,78,205,.06) inset,inset 0 1px rgba(255,255,255,.08); backdrop-filter:blur(14px) saturate(1.25); }
        ...
        .sa-overlay { position:absolute; inset:0; display:flex; align-items:center; justify-content:center; padding:clamp(12px,3vw,28px); background:radial-gradient(circle at 50% 20%,rgba(123,97,255,.22),rgba(6,8,20,.78) 60%),radial-gradient(circle at 18% 82%,rgba(255,78,205,.13),transparent 28%); opacity:0; visibility:hidden; pointer-events:none; transition:opacity .2s ease,visibility .2s ease; }
        ...
        .sa-panel { position:relative; width:min(522px,100%); max-height:calc(100vh - 28px); overflow:auto; padding:clamp(20px,4vw,32px); border:1px solid rgba(255,255,255,.12); border-radius:30px; background:linear-gradient(145deg,rgba(35,17,58,.97),rgba(9,15,35,.985) 68%); box-shadow:0 28px 85px rgba(0,0,0,.58),0 0 0 1px rgba(0,245,212,.04) inset,inset 0 1px rgba(255,255,255,.10); scrollbar-width:none; }
        .sa-panel::-webkit-scrollbar { width:0; height:0; }
        .sa-panel::before { content:""; position:absolute; width:250px; height:250px; right:-135px; top:-150px; border-radius:50%; background:radial-gradient(circle,rgba(255,78,205,.18),transparent 68%); pointer-events:none; }
        .sa-brand { position:relative; margin:0 0 6px; color:#88fff3; font-size:11px; font-weight:900; letter-spacing:.18em; text-transform:uppercase; text-shadow:0 0 14px rgba(0,245,212,.22); }
        .sa-title { position:relative; margin:0; font-size:clamp(32px,7vw,52px); line-height:.96; letter-spacing:-.065em; }
        .sa-subtitle { position:relative; margin:12px 0 20px; color:#d7cceb; font-size:15px; line-height:1.42; }
        .sa-btn { position:relative; display:block; width:100%; padding:15px 17px; margin-top:10px; border-radius:18px; background:linear-gradient(135deg,#ff4ecd,#7b61ff 55%,#00bbf9); box-shadow:0 12px 26px rgba(123,97,255,.28),inset 0 1px rgba(255,255,255,.25); font-size:16px; font-weight:900; transition:transform .14s ease,filter .14s ease; }
        ...
        .sa-btn.video { background:linear-gradient(135deg,#ffb703,#ff4d6d); box-shadow:0 12px 26px rgba(255,77,109,.24),inset 0 1px rgba(255,255,255,.25); }
        ...
        .sa-stat { padding:11px; min-height:64px; border:1px solid rgba(255,255,255,.08); border-radius:17px; background:linear-gradient(135deg,rgba(255,255,255,.05),rgba(0,245,212,.03)); }
        ...
        .sa-feature-preview { position:relative; display:block; width:100%; height:132px; margin:16px 0 6px; border:1px solid rgba(255,255,255,.10); border-radius:20px; background:linear-gradient(145deg,rgba(14,20,38,.82),rgba(38,18,53,.82)); }
        ...
        .sa-skin.selected { border-color:#00f5d4; box-shadow:0 0 0 2px rgba(0,245,212,.22),0 10px 25px rgba(255,78,205,.10); background:linear-gradient(145deg,rgba(0,245,212,.10),rgba(255,78,205,.09)); }
        ...
        .sa-hint { padding:9px 13px; border:1px solid rgba(255,255,255,.10); border-radius:999px; background:rgba(16,11,31,.72); box-shadow:0 8px 25px rgba(0,0,0,.2); color:#efe6ff; font-size:12px; font-weight:650; backdrop-filter:blur(9px); }
        .sa-toast { position:absolute; left:50%; top:86px; max-width:min(420px,calc(100vw - 24px)); transform:translate(-50%,-10px); opacity:0; pointer-events:none; padding:11px 14px; border:1px solid rgba(255,255,255,.13); border-radius:16px; background:rgba(18,12,34,.94); box-shadow:0 14px 38px rgba(0,0,0,.35); transition:opacity .18s ease,transform .18s ease; color:#fdf8ff; font-size:14px; font-weight:800; text-align:center; }
        ...
        .sa-menu-emblem { position:relative; flex:0 0 64px; width:64px; height:64px; margin-top:1px; overflow:hidden; border:1px solid rgba(0,245,212,.24); border-radius:18px; background:radial-gradient(circle at 72% 24%,rgba(255,78,205,.55),transparent 20%),linear-gradient(145deg,rgba(52,34,103,.74),rgba(8,14,31,.82)); box-shadow:inset 0 1px rgba(255,255,255,.18),0 10px 24px rgba(0,0,0,.20); }
        .sa-menu-emblem::before { content:""; position:absolute; left:8px; top:28px; width:49px; height:14px; border-radius:999px; background:linear-gradient(90deg,#00f5d4,#7b61ff 58%,#ff4ecd); box-shadow:0 0 13px rgba(182,129,255,.65),inset 0 2px rgba(255,255,255,.45); transform:rotate(-17deg); }
        .sa-menu-emblem span { position:absolute; right:7px; top:18px; width:19px; height:19px; border-radius:50%; background:radial-gradient(circle at 34% 30%,#fff 0 9%,#c8fff5 10% 22%,#00f5d4 23% 100%); box-shadow:0 0 12px rgba(0,245,212,.58); }
        ...
        .sa-joystick-ring { position:absolute; inset:6px; border:2px solid rgba(188,255,248,.30); border-radius:50%; background:radial-gradient(circle,rgba(123,97,255,.20),rgba(8,17,32,.46)); box-shadow:inset 0 0 28px rgba(255,78,205,.14),0 10px 32px rgba(0,0,0,.28); backdrop-filter:blur(6px); }
        ...
        .sa-joystick-knob { position:absolute; left:50%; top:50%; width:54px; height:54px; margin:-27px; border:1px solid rgba(240,251,255,.72); border-radius:50%; background:radial-gradient(circle at 35% 28%,#ffffff 0 8%,#ff87dd 9% 32%,#7b61ff 33% 100%); box-shadow:0 7px 20px rgba(123,97,255,.5),inset 0 1px rgba(255,255,255,.6); transition:transform .045s linear; }
        ...
        .sa-control-card.selected { border-color:#00f5d4; background:linear-gradient(145deg,rgba(0,187,249,.16),rgba(123,97,255,.15)); box-shadow:0 0 0 2px rgba(0,245,212,.16),0 12px 28px rgba(123,97,255,.12); }
        ...
        .sa-control-demo { position:relative; display:block; width:100%; height:79px; overflow:hidden; border:1px solid rgba(145,214,255,.12); border-radius:13px; background:linear-gradient(145deg,rgba(24,11,43,.86),rgba(8,12,28,.92)); }
        .sa-control-demo .sa-demo-snake { position:absolute; left:13px; top:41px; width:78px; height:18px; border-radius:999px; background:linear-gradient(90deg,#00f5d4,#9afff1); box-shadow:0 0 13px rgba(0,245,212,.40),inset 0 2px rgba(255,255,255,.52); transform:rotate(-17deg); }
        ...
        .sa-control-note { position:relative; margin:0 0 7px; padding:9px 10px; border:1px solid rgba(138,211,255,.16); border-radius:13px; background:rgba(123,97,255,.12); color:#ddd4f2; font-size:11px; font-weight:750; line-height:1.35; }
        ...
        .sa-gameover-daily { position:relative; display:grid; gap:2px; margin:11px 0 0; padding:10px 11px; border:1px solid rgba(0,245,212,.18); border-radius:15px; background:linear-gradient(135deg,rgba(0,187,249,.14),rgba(123,97,255,.18)); }
        ...
        .sa-loading-orb { width:62px; height:62px; margin:0 auto 15px; border:2px solid rgba(255,181,236,.30); border-top-color:#00f5d4; border-radius:50%; box-shadow:0 0 30px rgba(123,97,255,.22); animation:sa-spin .92s linear infinite; }
        .sa-loading-panel .sa-subtitle { margin:8px 0 0; }
        @keyframes sa-spin { to { transform:rotate(360deg); } }

        .sa-menu-actions .sa-social-btn { display:flex; align-items:center; justify-content:center; gap:7px; background:linear-gradient(145deg,rgba(77,45,128,.30),rgba(18,28,54,.92)); border:1px solid rgba(255,78,205,.18); box-shadow:inset 0 1px rgba(255,255,255,.11),0 8px 18px rgba(0,0,0,.14); }
        ...
        .sa-leaderboard-row:nth-child(1) { border-color:rgba(0,245,212,.42); background:linear-gradient(110deg,rgba(0,245,212,.12),rgba(255,255,255,.04)); }
        ...
        .sa-leaderboard-row.me { border-color:rgba(255,78,205,.42); background:rgba(255,78,205,.10); }
  ...
  createMenuCritters() {
    const palette = [
      ["#00f5d4", "#d4fff6"], ["#ff4ecd", "#ffd6f7"], ["#7b61ff", "#e3ddff"],
      ["#00bbf9", "#d7f4ff"], ["#ff7b72", "#ffe0de"], ["#9d4edd", "#eedcff"]
    ];
  ...
  draw() {
    ...
    background.addColorStop(0, "#150a24");
    background.addColorStop(.55, "#0d1029");
    ...
    ctx.save();
    ctx.lineWidth = Math.max(1, dpr);
    ctx.strokeStyle = "rgba(255,123,203,.08)";
    ctx.beginPath();
    ...
    ctx.strokeStyle = "rgba(0,245,212,.32)";
    ctx.lineWidth = 2 * dpr;
