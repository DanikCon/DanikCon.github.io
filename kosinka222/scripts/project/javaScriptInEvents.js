...
// Версия: GamePush v1.49.12 — OK force store refresh: detached purchase watcher + direct modal rerender; deck_frost7/deck_amber7.
(async () => {
  "use strict";
  ...
  function forceRefreshPurchaseStore() {
    ...
    // Replace the locked processing modal immediately with a freshly rendered purchase tab.
    openStore("purchase");
  ...
  async function purchaseSkin(id) {
    ...
    // replaced the processing modal. Do not wait for GamePush's still-pending purchase Promise.
