...
globalThis.__SLITHER_BUILD__ = "30-original-desktop-portrait-landscape-buttons";
  Snake: King of the Arena — original desktop/portrait + targeted mobile-landscape buttons v0.36
  ---------------------------------------------------------------
  ...
  createDom() {
    ...
    this.root.innerHTML = `
      <style>
        ...
        /* v30: only mobile landscape is customized. Desktop and portrait keep the
           original v19 presentation exactly as before. */
        @media (pointer:coarse) and (orientation:landscape) and (max-height:620px) {
          ...
          #slither-arena-root .sa-overlay > .sa-panel.sa-menu-panel {
            ...
            overflow:hidden !important;
            display:grid !important;
            grid-template-columns:minmax(0,.82fr) minmax(0,1.12fr) minmax(0,1.38fr) !important;
          ...
          #slither-arena-root .sa-menu-panel .sa-title {
            margin:0 !important;
            font-size:clamp(27px,4.15vw,45px) !important;
          ...
          /* One large Play row, then two perfectly even rows of three actions. */
          #slither-arena-root .sa-menu-panel .sa-menu-actions {
          ...
          #slither-arena-root .sa-menu-panel .sa-menu-actions .sa-rating-btn,
          #slither-arena-root .sa-menu-panel .sa-menu-actions .sa-social-btn {
            display:flex !important;
            align-items:center !important;
            justify-content:center !important;
          ...
          #slither-arena-root .sa-menu-panel .sa-menu-actions svg {
            flex:0 0 auto !important;
            width:16px !important;
            height:16px !important;
          }
          #slither-arena-root .sa-menu-panel .sa-menu-control-row { display:none !important; }

          /* Footer buttons on the other mobile-landscape screens remain orderly. */
          #slither-arena-root .sa-mission-actions {
            display:grid !important;
            grid-template-columns:repeat(2,minmax(0,1fr)) !important;
            gap:7px !important;
          ...
          #slither-arena-root .sa-shop-nav {
            display:grid !important;
            grid-template-columns:42px minmax(0,1fr) 42px !important;
            gap:7px !important;
          }
          #slither-arena-root .sa-shop-nav .sa-btn { margin:0 !important; }
        }

        @media (pointer:coarse) and (orientation:landscape) and (max-height:360px) {
          #slither-arena-root .sa-overlay > .sa-panel.sa-menu-panel { padding:8px 11px !important; gap:6px 10px !important; }
          ...
          #slither-arena-root .sa-menu-panel .sa-menu-actions { grid-auto-rows:34px !important; gap:5px !important; }
          #slither-arena-root .sa-menu-panel .sa-menu-actions .sa-btn,
          #slither-arena-root .sa-menu-panel .sa-menu-actions .sa-controls-btn,
          #slither-arena-root .sa-menu-panel .sa-menu-actions .sa-social-btn { height:34px !important; min-height:34px !important; font-size:10px !important; }
        }
