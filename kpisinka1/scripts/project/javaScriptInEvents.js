...
(async () => {
  ...
  function buildApp() {
    ...
    style.textContent = `
      ...
      .menu-grid .social-menu-btn{position:relative;justify-content:center;text-align:center;padding-left:40px;padding-right:40px}.menu-grid .social-menu-btn .button-icon{position:absolute;left:12px;top:50%;transform:translateY(-50%);margin:0;width:18px;height:18px}.menu-grid .social-menu-btn .button-icon + span{display:block;width:100%;min-width:0;text-align:center;line-height:1.15}
