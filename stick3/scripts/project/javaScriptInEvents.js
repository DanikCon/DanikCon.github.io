    ...
    if (globalThis.portalTimer <= 0) {
        ...
        if (!document.getElementById('victory-screen')) {
            ...
            if (currentNum >= TOTAL_LEVELS) {
                ...
                // ==========================================
                // ==========================================
                // ⚙️ ЛОГИКА СОЦИАЛЬНЫХ КНОПОК (ПОКАЗЫВАЕМ ВСЕГДА)
                // ==========================================
                const socialContainer = document.getElementById('social-container');
                
                // 1. ЖЕЛЕЗОБЕТОННАЯ ПЛАТФОРМА (По умолчанию - ВК)
                let gpPlatform = 'VK'; 

                // Проверяем, вдруг мы всё-таки в Одноклассниках
                ...
                // 2. ОТРИСОВКА И КЛИКИ (Теперь без условий if, рисуем всегда!)
