...
if (!globalThis.StickmanMainMenu) {
    globalThis.StickmanMainMenu = {
        ...
        isMobileDevice() {
            try {
                // Та же логика, что в подсказке управления на первом уровне:
                // определяем мобильное устройство по userAgent, а не по размеру окна и не по maxTouchPoints.
                // Так ПК, ноутбук с тач-экраном или маленькое окно браузера не будут ошибочно считаться телефоном.
